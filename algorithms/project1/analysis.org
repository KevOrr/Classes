...
#+BEGIN_SRC lisp :package time-sorts :exports none :results none
...
#+NAME: stats-table
#+BEGIN_SRC lisp :package time-sorts :post insert-hlines(table=*this*) :exports results :results value
